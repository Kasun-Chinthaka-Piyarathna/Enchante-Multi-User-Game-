...
public class LeaderboardSample5 extends Activity implements AsyncApp42ServiceApi.App42ScoreBoardServiceListener{
    /**
     * The async service.
     */
    ...
    public void onNextClicked(View view) {
        ...
        Intent mainIntent = new Intent(this, Level06.class);
        this.startActivity(mainIntent);
    }
    ...
    public void onLeaderBoardSuccess(Game response) {
        ...
        LeaderboardAdapter adapter = new LeaderboardAdapter(LeaderboardSample5.this, nameList, rankList, scoreList);
