...
public class LeaderboardSample4 extends Activity implements AsyncApp42ServiceApi.App42ScoreBoardServiceListener{
    ...
    public void onNextClicked(View view) {
        ...
        Intent mainIntent = new Intent(this, Level05.class);
        this.startActivity(mainIntent);
    }
    ...
    public void onLeaderBoardSuccess(Game response) {
        ...
        LeaderboardAdapter adapter = new LeaderboardAdapter(LeaderboardSample4.this, nameList, rankList, scoreList);
