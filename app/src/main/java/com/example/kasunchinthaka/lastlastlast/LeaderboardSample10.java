...
public class LeaderboardSample10 extends Activity implements AsyncApp42ServiceApi.App42ScoreBoardServiceListener{
    /**
     * The async service.
     */
    ...
    public void onNextClicked(View view) {
        ...
        Intent mainIntent = new Intent(this, complete.class);
        this.startActivity(mainIntent);
    }
    ...
    public void onLeaderBoardSuccess(Game response) {
        ...
        LeaderboardAdapter adapter = new LeaderboardAdapter(LeaderboardSample10.this, nameList, rankList, scoreList);
