...
public class CurrentLeaderBoard extends Activity implements AsyncApp42ServiceApi.App42ScoreBoardServiceListener{
    ...
    public void onLeaderBoardSuccess(Game response) {
        ...
        LeaderboardAdapter adapter = new LeaderboardAdapter(CurrentLeaderBoard.this, nameList, rankList, scoreList);
