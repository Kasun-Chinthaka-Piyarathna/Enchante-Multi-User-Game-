...
public class LeaderboardSample3 extends Activity implements AsyncApp42ServiceApi.App42ScoreBoardServiceListener{
    /**
     * The async service.
     */
    ...
    public void onNextClicked(View view) {
        ...
        Intent mainIntent = new Intent(this, Level04.class);
        this.startActivity(mainIntent);
    }
    ...
    public void onLeaderBoardSuccess(Game response) {
        ...
        LeaderboardAdapter adapter = new LeaderboardAdapter(LeaderboardSample3.this, nameList, rankList, scoreList);
