...
public class leaderboardSample7 extends Activity implements AsyncApp42ServiceApi.App42ScoreBoardServiceListener {
    ...
    public void onNextClicked(View view) {
        ...
        Intent mainIntent = new Intent(this, Level08.class);
        this.startActivity(mainIntent);
    }
    ...
    public void onLeaderBoardSuccess(Game response) {
        ...
        LeaderboardAdapter adapter = new LeaderboardAdapter(leaderboardSample7.this, nameList, rankList, scoreList);
