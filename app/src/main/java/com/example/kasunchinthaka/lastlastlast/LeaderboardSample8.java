...
public class LeaderboardSample8 extends Activity implements AsyncApp42ServiceApi.App42ScoreBoardServiceListener{
    ...
    public void onNextClicked(View view) {
        ...
        Intent mainIntent = new Intent(this, Level09.class);
        this.startActivity(mainIntent);
    }
    ...
    public void onLeaderBoardSuccess(Game response) {
        ...
        LeaderboardAdapter adapter = new LeaderboardAdapter(LeaderboardSample8.this, nameList, rankList, scoreList);
